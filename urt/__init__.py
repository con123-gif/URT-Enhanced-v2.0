...
# appears at the multiplicity of its eigenspace.
from .discrete_black_hole_g13 import (
    SPECTRUM,
...
from .ihara_zeta_g13 import (
    graph_topology,
    adjacency_spectrum,
    adjacency_spectrum_cathedral_form,
    closed_walk_count,
    closed_walk_cathedral_table,
    triangle_count_cathedral,
    hashimoto_matrix,
    hashimoto_eigenvalue_distribution,
    ramanujan_property,
