...
def genuine_predictions() -> list[dict]:
    ...
    preds = [
        ...
        },
        {
            ...
            "uncertainty":  0.006,
            "status":       "confirmed",
            "falsified_if": "Ω_m measured < 0.295 or > 0.330",
            "note":         "K4/shell ratio with γ-correction. 1.4% high — possibly needs 2-loop.",
        },
        {
...
def honest_assessment() -> dict:
    ...
    return {
        ...
        "well_motivated": [
            "Ω_m = (4/13)(1+2γ): K4/shell ratio + exhaust leakage. 1.4% high — plausible 2-loop",
